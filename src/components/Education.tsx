                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div
                      className={`p-3 rounded-full ${
                        index === 0 ? 'bg-accent-primary/20 text-accent-primary' : 'bg-accent-secondary/20 text-accent-secondary'
                      }`}
                    >
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                      <h3 className="text-xl font-mono font-semibold text-accent-primary">{edu.degree}</h3>
                    ...
                    <p className="text-text-primary mb-3">{edu.school}</p>

                    <span className="skill-tag border-success text-success">{t('education.status.completed')}</span>
                  </div>
                </div>
              </div>
            ))}
